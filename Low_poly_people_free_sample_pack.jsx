...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF('/low_poly_people_free_sample_pack.glb')
              ...
              <group name="RootNode">
                ...
                <group name="rig_CharRoot" position={[-218.334, 0, 30.841]} rotation={[-Math.PI / 2, 0, 0.52]}>
                  <group name="Object_6">
                    ...
                    <skinnedMesh name="Object_9" geometry={nodes.Object_9.geometry} material={materials.peopleColorsFam} skeleton={nodes.Object_9.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot001" position={[-78.338, -1.27, -23.678]} rotation={[-Math.PI / 2, 0, 0.322]}>
                  <group name="Object_50">
                    ...
                    <skinnedMesh name="Object_53" geometry={nodes.Object_53.geometry} material={materials.peopleColorsFam} skeleton={nodes.Object_53.skeleton} />
                    <skinnedMesh name="Object_94" geometry={nodes.Object_94.geometry} material={materials.peopleColorsFam} skeleton={nodes.Object_94.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot002" position={[105.27, 0, -21.835]} rotation={[-Math.PI / 2, 0, 0]}>
                  <group name="Object_98">
                    ...
                    <skinnedMesh name="Object_101" geometry={nodes.Object_101.geometry} material={materials.peopleColorsFam} skeleton={nodes.Object_101.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot003" position={[-181.689, -7.159, -25.256]} rotation={[-Math.PI / 2, 0, 0.292]}>
                  <group name="Object_142">
                    ...
                    <skinnedMesh name="Object_145" geometry={nodes.Object_145.geometry} material={materials.peopleColors} skeleton={nodes.Object_145.skeleton} />
                    <skinnedMesh name="Object_186" geometry={nodes.Object_186.geometry} material={materials.peopleColors} skeleton={nodes.Object_186.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot004" position={[-118.157, 0, 93.47]} rotation={[-Math.PI / 2, 0, 1.348]}>
                  <group name="Object_190">
                    ...
                    <skinnedMesh name="Object_193" geometry={nodes.Object_193.geometry} material={materials.peopleColors} skeleton={nodes.Object_193.skeleton} />
                    <skinnedMesh name="Object_239" geometry={nodes.Object_239.geometry} material={materials.peopleColors} skeleton={nodes.Object_239.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot005" position={[207.94, -0.585, 36.974]} rotation={[-Math.PI / 2, 0, -0.289]}>
                  <group name="Object_243">
                    ...
                    <skinnedMesh name="Object_246" geometry={nodes.Object_246.geometry} material={materials.peopleColors} skeleton={nodes.Object_246.skeleton} />
                    <skinnedMesh name="Object_288" geometry={nodes.Object_288.geometry} material={materials.peopleColors} skeleton={nodes.Object_288.skeleton} />
                    <skinnedMesh name="Object_290" geometry={nodes.Object_290.geometry} material={materials.peopleColors} skeleton={nodes.Object_290.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot006" position={[-1.245, 0, 74.505]} rotation={[-Math.PI / 2, 0, 0]}>
                  <group name="Object_295">
                    ...
                    <skinnedMesh name="Object_298" geometry={nodes.Object_298.geometry} material={materials.peopleColors} skeleton={nodes.Object_298.skeleton} />
                    <skinnedMesh name="Object_339" geometry={nodes.Object_339.geometry} material={materials.peopleColors} skeleton={nodes.Object_339.skeleton} />
                  </group>
                </group>
                ...
                <group name="rig_CharRoot007" position={[125.485, 0, 103.298]} rotation={[-Math.PI / 2, 0, -1.532]}>
                  <group name="Object_343">
                    ...
                    <skinnedMesh name="Object_346" geometry={nodes.Object_346.geometry} material={materials.peopleColors} skeleton={nodes.Object_346.skeleton} />
                  </group>
                </group>
              </group>
            </group>
...
useGLTF.preload('/low_poly_people_free_sample_pack.glb')
